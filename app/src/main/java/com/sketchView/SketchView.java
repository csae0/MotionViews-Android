...
//    public boolean showBounds = false;
    ...
    private Rect getImageBounds() {
        if (incrementalImage != null) {
            ...
            int fillColor = Color.rgb(217, 179, 140); // Color brown with transparency (should be likely not to be chosen) // TODO: remember colors which are drawn on sketchView
